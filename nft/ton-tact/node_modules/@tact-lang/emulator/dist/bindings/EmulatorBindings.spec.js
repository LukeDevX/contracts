...
const EmulatorBindings_1 = require("./EmulatorBindings");
...
describe('EmulatorBindings', () => {
    it('should create bindings', async () => {
        let code = core_1.Cell.fromBoc(Buffer.from(echoCode, 'base64'))[0];
        let data = (0, core_1.beginCell)()
            .storeRef(core_1.Cell.EMPTY)
            .storeInt(0, 257)
            .endCell();
        let bindings = new EmulatorBindings_1.EmulatorBindings();
        let res = await bindings.runGetMethod({
            verbosity: 4,
            code,
            data,
            address: (0, core_1.contractAddress)(0, { code, data }),
            config: defaultConfig_1.defaultConfig,
    ...
    it('should execute emulator case', async () => {
        ...
        let res = await bindings.runGetMethod({
            ...
            methodId: 93099,
            args: [],
            config: core_1.Cell.fromBase64('')
        });
