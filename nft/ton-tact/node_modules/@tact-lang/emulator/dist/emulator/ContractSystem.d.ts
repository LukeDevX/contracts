...
import { AddressSource } from "../utils/addressSource";
...
export declare class ContractSystem {
     ...
     */
    contract(contract: AddressSource): ContractExecutor;
    /**
     ...
     */
    track(contract: AddressSource): Tracker;
    /**
     * Create a logger for a contract
     * @param address contract or it's address
     */
    log(contract: AddressSource): Logger;
    /**
     * Sets contract name
     * @param contract contract or it's address
     * @param name optional name
     */
    name(contract: AddressSource, name: string | null): void;
    /**
     * Verbose level for a contract
     * @param contract contract or it's address
     * @param level verbosity level
     */
    verbosity(contract: AddressSource, level: Verbosity): void;
    /**
     * Send external message
     * @param message
     */
    send(message: Message): void;
    tryParseContractMessage(address: Address, src: Cell): any;
