...
const ton_abi_1 = require("@tact-lang/ton-abi");
/**
...
class ContractSystem {
    ...
    constructor(args) {
        ...
        _ContractSystem_abiTypes.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _ContractSystem_abiTypes, new Map(), "f");
    }
    /**
    ...
    treasure(seed, workchain = 0) {
        ...
        executor.balance = (0, core_1.toNano)(1000000);
    ...
    open(src) {
        ...
        if (src.abi) {
            ...
            let registry = new ton_abi_1.TypeRegistry();
            try {
                if (src.abi.types) {
            ...
            __classPrivateFieldGet(this, _ContractSystem_abiTypes, "f").set(src.address.toString({ testOnly: true }), registry);
        }
        // Open contract
        return (0, core_1.openContract)(src, (params) => __classPrivateFieldGet(this, _ContractSystem_instances, "m", _ContractSystem_provider).call(this, params.address, params.init));
    }
    /**
     * Run until stop
     */
    ...
    // Utility
    //
    tryParseContractMessage(address, src) {
        try {
            let b = __classPrivateFieldGet(this, _ContractSystem_abiTypes, "f").get(address.toString({ testOnly: true }));
            if (!b) {
                return undefined;
            }
...
_ContractSystem_config = new WeakMap(), _ContractSystem_now = new WeakMap(), _ContractSystem_lt = new WeakMap(), _ContractSystem_bindings = new WeakMap(), _ContractSystem_contracts = new WeakMap(), _ContractSystem_abis = new WeakMap(), _ContractSystem_abiTypes = new WeakMap(), _ContractSystem_pending = new WeakMap(), _ContractSystem_trackers = new WeakMap(), _ContractSystem_loggers = new WeakMap(), _ContractSystem_verbosity = new WeakMap(), _ContractSystem_send = new WeakMap(), _ContractSystem_instances = new WeakSet(), _ContractSystem_provider = function _ContractSystem_provider(address, init) {
    ...
    return {
        ...
        get: async (name, args) => {
            ...
            if (res.exitCode !== 0 && res.exitCode !== 1) {
                ...
                if (abi && abi.errors && abi.errors[res.exitCode]) {
                    throw new core_1.ComputeError(abi.errors[res.exitCode].message, res.exitCode, { logs: res.logs });
                }
                else {
                    throw new core_1.ComputeError('Exit code: ' + res.exitCode, res.exitCode, { logs: res.logs });
                }
            }
        ...
        external: async (msg) => {
            ...
            // Send message
            __classPrivateFieldGet(this, _ContractSystem_send, "f").call(this, (0, core_1.external)({
                to: address,
                init: neededInit,
                body: msg
            }));
