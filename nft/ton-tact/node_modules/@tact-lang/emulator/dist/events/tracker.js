    ...
    track(seq, tx, system) {
        ...
        if (tx.description.storagePhase) {
            if (tx.description.storagePhase.storageFeesCollected > 0n) {
                events.push({ $type: 'storage-charged', amount: (0, core_1.fromNano)(tx.description.storagePhase.storageFeesCollected) });
            }
...
function convertMessage(src, system) {
    // Internal message
    if (src.info.type === 'internal') {
        ...
        return {
            ...
            from,
            to,
            value: (0, core_1.fromNano)(src.info.value.coins),
...
function convertBody(src, address, system) {
